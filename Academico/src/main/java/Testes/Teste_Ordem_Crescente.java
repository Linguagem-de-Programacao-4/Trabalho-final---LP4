...
public class Teste_Ordem_Crescente {
    ...
    public static void main(String[] args) throws MinhaExcpetion {
        ...
        System.out.println("-----Lista de notas em ordem crescente--------");
        System.out.println(a1.retornaCrescente());
        System.out.println("----------------------------------------------");
        System.out.println(a2.retornaCrescente());
        System.out.println("----------------------------------------------");
        System.out.println(a3.retornaCrescente());
        System.out.println("-----------------------------------------------");
